...
const translations = {
  ru: {
    ...
    acc1_guests: "2 гостя",
    acc1_desc: " Уютный барнхаус с террасой, двуспальной кроватью и панорамным окном в лес.",
    acc2_title: "4-местный барнхаус",
    acc2_guests: "4 гостя",
    acc2_desc: " Просторный барнхаус с раскладным диваном, мини-баром и собственной чайной станцией.",
    acc3_title: "2-местный барнхаус",
    acc3_guests: "2 гостя",
    acc3_desc: " Барнхаус с видом на озеро Щучье прямо из окна — идеален для рассветов и закатов.",
    ...
    amenity2_desc: "Кафе грузинской кухни на территории, кухня работает до 23:00.",
    ...
    amenity4_desc: "Зона с мангалом — включена в стоимость проживания.",
    ...
    faq4_a: "Кухня грузинского ресторана на территории работает до 23:00. Сама база отдыха открыта круглосуточно.",
